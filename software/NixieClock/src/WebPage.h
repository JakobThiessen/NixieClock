...
<body style="background-color: #756e6e" onload="process()">

  <header>
    <div class="navbar fixed-top">
      <div class="container">
        <div class="navtitle">Nixie Clock</div>
  ...
  <main class="container" style="margin-top:70px">
    <div class="category">RGB Control</div>
    <br>
    <div class="bodytext">Switch RGB-LED</div>
    <button type="button" class="btn" id="btn1" onclick="ButtonPress0()">Toggle</button>
    </div>
    <br>
    <br>
    <div class="bodytext">Brightness 0-255 ( <span id="fanrpm"></span> )</div>
    <br>
    <input type="range" class="brightness" min="0" max="255" value="0" width="0%"
